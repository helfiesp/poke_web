...
class product_form(forms.ModelForm):
    class Meta:
        model = product
        fields = ['title', 'subtitle', 'category', 'description', 'product_url', 'price', 'sale_price', 'height', 'width', 'length', 'weight', 'instock', 'more_information', 'supplier', 'enabled', 'bestseller']
